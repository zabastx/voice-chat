...
// Telegram delivers updates here. We verify the secret header, then forward the
// raw update to the main app's ingest endpoint (which owns all the linking/reply
