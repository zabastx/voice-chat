...
impl DesktopEvent {
    fn message(self) -> &'static str {
        match self {
            ...
            // Never the notification text: a desktop log must not become a copy of the chat.
            Self::NotificationShown => "notification shown",
            Self::NotificationFailed => "notification failed",
            Self::NotificationRateLimited => "notification rate limited",
